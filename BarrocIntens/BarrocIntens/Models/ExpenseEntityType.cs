    ...
    internal partial class ExpenseEntityType
    {
        ...
        public static RuntimeForeignKey CreateForeignKey1(RuntimeEntityType declaringEntityType, RuntimeEntityType principalEntityType)
        {
            ...
            var expenses = principalEntityType.AddNavigation("Expenses",
                runtimeForeignKey,
                onDependent: false,
                typeof(ICollection<Expense>),
                propertyInfo: typeof(User).GetProperty("Expenses", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(User).GetField("<Expenses>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly));
