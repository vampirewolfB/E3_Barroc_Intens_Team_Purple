    ...
    internal partial class QuoteProductEntityType
    {
        ...
        public static RuntimeForeignKey CreateForeignKey2(RuntimeEntityType declaringEntityType, RuntimeEntityType principalEntityType)
        {
            ...
            var quoteProducts = principalEntityType.AddNavigation("QuoteProducts",
                ...
                propertyInfo: typeof(Quote).GetProperty("QuoteProducts", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(Quote).GetField("<QuoteProducts>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly));
